...
<template>
  <div class="relative items-start flex">
    ...
    <div
      class="lg:px-[30px] basis-full lg:basis-full self-stretch flex flex-col flex-1 col-span-9 xl:col-span-9 4xl:col-span-6 lg:py-[30px] 4xl:px-[44px] 4xl:py-[44px]"
    >
